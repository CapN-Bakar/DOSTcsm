    ...
    <>
      ...
      <div className={sqdstyle.container} id={sqdstyle.box}>
        <div className={sqdstyle.question}>
          <h1>SQD6. I feel the office was fair to everyone, or "walang palakasan", during my transaction.</h1>
        </div>
        ...
        <div className={sqdstyle.navigation}>
          <a href="/sqd5" className={sqdstyle.buttons}>
            Back
          </a>
          <a href="/sqd7" className={sqdstyle.buttons} onClick={(event) => {
