    ...
    <>
      ...
      <div className={sqdstyle.container} id={sqdstyle.box}>
        <div className={sqdstyle.question}>
          <h1>SQD5. I paid a reasonable amount of fees for my transaction.</h1>
        </div>
        ...
        <div className={sqdstyle.navigation}>
          <a href="/sqd4" className={sqdstyle.buttons}>
            Back
          </a>
          <a href="/sqd6" className={sqdstyle.buttons} onClick={(event) => {
