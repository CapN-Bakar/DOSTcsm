    ...
    <>
      ...
      <div className={sqdstyle.container} id={sqdstyle.box}>
        <div className={sqdstyle.question}>
          <h1>SQD8. I got what I needed from the government office, or (if denied) denial of request was sufficiently explained to me.</h1>
        </div>
        ...
        <div className={sqdstyle.navigation}>
          <a href="/sqd7" className={sqdstyle.buttons}>
            Back
          </a>
          <a href="/suggestion" className={sqdstyle.buttons} onClick={(event) => {
