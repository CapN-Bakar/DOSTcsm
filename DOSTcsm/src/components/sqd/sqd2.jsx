    ...
    <>
      ...
      <div className={sqdstyle.container} id={sqdstyle.box}>
        <div className={sqdstyle.question}>
          <h1>SQD2. The office followed the transaction's requirements and steps based on the information provided.</h1>
        </div>
        ...
        <div className={sqdstyle.navigation}>
          <a href="/sqd1" className={sqdstyle.buttons}>
            Back
          </a>
          <a href="/sqd3" className={sqdstyle.buttons} onClick={(event) => {
