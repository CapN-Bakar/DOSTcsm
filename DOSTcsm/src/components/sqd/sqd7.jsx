    ...
    <>
      ...
      <div className={sqdstyle.container} id={sqdstyle.box}>
        <div className={sqdstyle.question}>
          <h1>SQD7. I was treated courteously by the staff, and (if asked for help) the staff was helpful.</h1>
        </div>
        ...
        <div className={sqdstyle.navigation}>
          <a href="/sqd6" className={sqdstyle.buttons}>
            Back
          </a>
          <a href="/sqd8" className={sqdstyle.buttons} onClick={(event) => {
